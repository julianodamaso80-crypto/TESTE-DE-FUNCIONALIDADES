...
urlpatterns = [
    ...
    path('runs/<uuid:run_id>/rerun-failed/', views.rerun_failed, name='rerun_failed'),
    path('runs/<uuid:run_id_a>/compare/<uuid:run_id_b>/', views.run_compare, name='run_compare'),
